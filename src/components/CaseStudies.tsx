...
const cases = [
  ...
  },
  {
    ...
    metric: "+Leads",
    body: "Built a clean and modern business website focused on credibility and enquiries.",
    person: "Client",
  ...
  },
  {
    ...
    metric: "+Orders",
    body: "Created a premium floral website designed to increase online orders.",
    person: "Client",
