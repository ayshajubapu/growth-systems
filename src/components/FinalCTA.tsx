    ...
    >
      <div className="relative w-full">
        ...
        <div className="text-center mb-14 sm:mb-20">
          <p className="cta-el text-xs tracking-[0.12em] text-accent mb-4 block">
          ...
          <p className="cta-el mt-6 text-muted-foreground text-sm sm:text-base max-w-xl mx-auto leading-relaxed">
            No jargon. No pressure. Just honest advice from a Chennai team
            about whether we’re the right fit for your business goals.
          </p>
        </div>

        {/* Dynamic Split Action Layout */}
          ...
          <div className="lg:col-span-7 grid sm:grid-cols-2 gap-4">
            {[
              ...
              >
                ...
                <div>
                  <span className="text-xs uppercase tracking-[0.12em] text-muted-foreground block mb-1">
                    {label}
                  </span>
            ...
            {isSuccess ? (
              <div className="text-center py-6 flex flex-col items-center justify-center animate-fade-in">
                ...
                <p className="text-xs text-muted-foreground max-w-[240px] mx-auto">
                  Your details were sent to us on WhatsApp — we'll get back
              ...
              <form onSubmit={handleQuickSubmit} className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Drop your email below and we'll touch base with you.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-accent text-accent-foreground font-semibold px-4 py-2.5 rounded-lg text-xs hover:bg-accent/95 disabled:opacity-50 transition-colors"
                  >
                    {isSubmitting ? (
                      "Connecting..."
                    ) : (
